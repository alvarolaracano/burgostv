...
public class BuscarActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        grupoOrdenar.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
        ...
        botonBuscar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(busqueda.length()<2){
					...
					//Mensaje de error
					Toast.makeText(BuscarActivity.this, "La búsqueda es demasido corta", Toast.LENGTH_LONG).show();
					...
					String URL_BUSQUEDA = URL + "?busqueda=" + busqueda + "&tipo=" + tipo;
