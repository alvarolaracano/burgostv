...
import com.alvarolara.burgostv.ObjetosActivity;
...
public class CargaXML extends AsyncTask<Void , Void , Void> {
	 ...
	 * @param context
	 */
    public CargaXML(Context context, String URL){
        this.targetCtx = context ;
        this.URL = URL;
        
        //Preparar el ProgressDialog.
        progress = new ProgressDialog(targetCtx);
 	    ...
 	    try{
	 	    ...
	 	    if(nl.getLength()==0){
		 	    ...
		 	    for (int i = 0; i < nl.getLength(); i++) {
		 	        ...
		 	        map.put(KEY_DESCRIPCION, parser.getValor(e, KEY_DESCRIPCION));
 	    	...
 	    	error = true;
 	    	targetCtx.startActivity(new Intent(targetCtx.getApplicationContext(), ErrorActivity.class));
 	    }
       return null ;
    }
    ...
    protected void onPostExecute(Void params){
        ...
        if(!error){
	        ...
	        Intent in = new Intent(targetCtx.getApplicationContext(), ObjetosActivity.class);
	        in.putExtra("xml",menuItems);
	        targetCtx.startActivity(in);
        }
    }
}
